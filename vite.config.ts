	...
	return {
		...
		resolve: {
			alias: [
				...
				{ find: "@components", replacement: resolveFromRoot("source/components") },
				{ find: "@hooks", replacement: resolveFromRoot("source/hooks") },
				{ find: "@utils", replacement: resolveFromRoot("source/utils") },
				{ find: "@services", replacement: resolveFromRoot("source/services") },
				{ find: "@styles", replacement: resolveFromRoot("source/styles") },
				{ find: "@features", replacement: resolveFromRoot("source/features") },
				{ find: "@core", replacement: resolveFromRoot("source") },
			],
