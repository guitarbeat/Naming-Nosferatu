        ...
        return {
                ...
                resolve: {
                        alias: {
                                ...
                                "@components": resolveFromRoot("source/components"),
                                "@hooks": resolveFromRoot("source/hooks"),
                                "@utils": resolveFromRoot("source/utils"),
                                "@services": resolveFromRoot("source/services"),
                                "@styles": resolveFromRoot("source/styles"),
                                "@features": resolveFromRoot("source/features"),
                                "@supabase/client": resolveFromRoot("supabase/client.ts"),
                                "@supabase/types": resolveFromRoot("supabase/types.ts"),
                        },
