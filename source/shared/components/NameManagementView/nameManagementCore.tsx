...
export const NameManagementContext =
  createContext<UseNameManagementViewResult | null>(null);
...
export interface UseNameManagementViewResult {
  ...
  setSelectionFilter: React.Dispatch<
    React.SetStateAction<"all" | "selected" | "unselected">
  >;
  userFilter: string;
