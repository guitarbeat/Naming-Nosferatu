/**
 * @module supabaseClientBase
 * @description Base Supabase client configuration and utility functions.
 * Separated to avoid circular dependencies with feature modules.
 */
