	...
	({
		...
		return (
			<div className={styles.undoBanner} role="status">
				...
				<Button variant="primary" size="small" onClick={onUndo} className={styles.undoButton}>
					Undo (Esc)
				</Button>
			</div>
		);
				...
				>
					<Card className="max-w-md p-8 text-center bg-slate-900 border border-white/10 rounded-2xl">
						...
						<p className="mb-6 text-slate-300">
							Select your favorite name by clicking or using arrow keys. You can also choose both or
							skip.
						</p>
