...
export const PersonalResults = ({
	...
	const handleSave = useCallback(
		async (updatedRankings: NameItem[]) => {
			// ⚡ Bolt Optimization: Replaced Object.fromEntries(map) with a single-pass loop
			// to avoid intermediate array allocations and improve iteration performance.
