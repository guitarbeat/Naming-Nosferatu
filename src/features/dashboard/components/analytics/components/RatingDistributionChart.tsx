...
export function RatingDistributionChart({
	...
	const ratings = useMemo(() => {
		// ⚡ Bolt Optimization: Replacing O(N) chained `.filter().map()` with a single-pass
		// for-loop to avoid allocating intermediate arrays and reduce garbage collection overhead.
		const result: number[] = [];
