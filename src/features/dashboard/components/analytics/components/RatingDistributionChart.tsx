...
export function RatingDistributionChart({ leaderboard }: RatingDistributionChartProps) {
	const ratings = useMemo(() => {
		// ⚡ Bolt: Optimized filtering and mapping into a single pass.
		// Replaced .filter().map() with a for loop to avoid intermediate array allocations
		// and reduce garbage collection overhead during dashboard renders.
		const result = [];
