...
interface AdminNamesFilterBarProps {
	searchTerm: string;
	onSearchTermChange: (value: string) => void;
	filterStatus: string;
	filterOptions: readonly { value: string; label: string }[];
...
function AdminNamesBulkActions({
	selectedCount,
	onBulkAction,
	onClearSelection,
...
interface AdminNameListItemProps {
	name: NameWithStats;
	isSelected: boolean;
	onSelectionChange: (nameId: string, checked: boolean) => void;
	onToggleHidden: (nameId: string | number, isHidden: boolean) => void;
