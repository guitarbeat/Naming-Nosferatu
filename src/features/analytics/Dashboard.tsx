...
export function Dashboard({
        ...
        // Keep toast in a ref so effects that use it don't re-run when toast state changes
        ...
        useEffect(() => {
                const fetchLeaderboard = async () => {
                        ...
                        try {
                                ...
                                toastRef.current.showWarning("Could not load the leaderboard. Please try refreshing.");
                        } finally {
        ...
        const fetchEngagementMetrics = useCallback(async () => {
                ...
                try {
                        ...
                        toastRef.current.showWarning("Could not load engagement metrics.");
                } finally {
        ...
        useEffect(() => {
                const fetchStats = async () => {
                        ...
                        try {
                                ...
                                toastRef.current.showWarning("Could not load statistics. Please try refreshing.");
                        } finally {
                                setIsLoadingStats(false);
                        }
                };
        ...
        const handleUnhideName = async (nameId: string | number) => {
                ...
                try {
                        ...
                        toastRef.current.showWarning("Could not unhide that name. Please try again.");
                }
        };
