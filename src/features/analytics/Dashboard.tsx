                        ...
                        <div className="grid gap-6 xl:grid-cols-[minmax(0,22rem)_1fr]">
                                <Panel>
                                        ...
                                        {isLoadingLeaderboard ? (
                                                ...
                                                <EmptyState variant="box" title="No ratings yet. Start a tournament to create the first leaderboard." />
                                        )}
                                </Panel>
                        ...
                        {isAdmin && (
                                <Panel>
                                        ...
                                        {showHiddenNames ? (
                                                ...
                                                <EmptyState variant="box" title="Open the list to review and restore hidden names." className="border-dashed bg-black/10" />
                                        )}
                                </Panel>
                        )}
                </div>
