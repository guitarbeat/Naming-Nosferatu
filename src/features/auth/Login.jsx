          ...
          >
            ...
            >
              <div className={styles.inputWrapper}>
                <div className={`${styles.inputContainer} cat-input-container`}>
                  {/* Sleeping Cat positioned over input */}
                  <div
                    className={`${styles.catMouseDetector} mouse-detector`}
                    ref={catRef}
                  >
                    <div className="cat">
                  ...
                  <input
                    ...
                    className={`${styles.loginInput} cat-input ${error ? styles.error : ""}`}
                    autoFocus
                    autoComplete="off"
                    autoCapitalize="none"
                    spellCheck={false}
