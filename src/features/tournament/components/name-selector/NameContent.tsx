...
export const NameContent = ({
	...
	const nameClasses = isGrid
		? "w-full break-words font-whimsical text-2xl leading-[0.92] tracking-tight text-white sm:text-[2rem] drop-shadow-lg"
		: "w-full break-words font-whimsical text-4xl leading-[0.92] tracking-tight text-white lg:text-5xl drop-shadow-lg";
