...
import { TournamentHeader, TournamentFooter, ProgressMilestone } from './TournamentUI';
...
describe('TournamentUI', () => {
  describe('TournamentHeader', () => {
    it('displays round and match info', () => {
      render(<TournamentHeader roundNumber={1} currentMatchNumber={5} totalMatches={10} progress={50} />);
