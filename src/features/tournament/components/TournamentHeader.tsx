				...
				<div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
					...
					<div className="flex flex-wrap items-center gap-2">
						...
						<Button
							variant="ghost"
							onClick={() => handleUndo()}
							className={`h-10 rounded-xl border px-3 text-sm gap-2 ${
								canUndo
						...
						<Button
							...
							className="h-10 rounded-xl border border-destructive/30 bg-destructive/12 px-3 text-sm text-destructive hover:bg-destructive/18 hover:text-destructive gap-2"
