...
function HeaderControls({
	...
	handleUndo,
	quitTournament,
}: Pick<TournamentHeaderProps, "audioManager" | "canUndo" | "handleUndo" | "quitTournament">) {
	return (
...
function MatchProgress({
	...
	TournamentHeaderProps,
	"currentMatchNumber" | "totalMatches" | "stageHeadline" | "dominantStreak"
>) {
	return (
...
function HeaderStats({
	...
	TournamentHeaderProps,
	"matchupTone" | "pressureCopy" | "matchesRemaining" | "roundMatchesLeft"
>) {
	return (
