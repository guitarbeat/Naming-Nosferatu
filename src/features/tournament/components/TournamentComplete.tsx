			...
			<div className="relative z-10 flex w-full max-w-2xl flex-col items-center px-6 text-center sm:px-8">
				...
				<div className="mt-10 flex w-full flex-col gap-3">
					<Button
						...
						className="w-full flex items-center justify-center gap-2.5 font-semibold shadow-[0_0_30px_rgba(180,120,255,0.35)] hover:shadow-[0_0_40px_rgba(180,120,255,0.55)]"
					>
						<Trophy size={15} />
						View Analysis
					</Button>
					...
					<Button
						...
						className="w-full flex items-center justify-center gap-2.5 border border-white/15 bg-white/[0.05] text-white/70 hover:border-white/25 hover:bg-white/10 hover:text-white"
					>
						<LogOut size={15} />
