	...
	return (
		...
		>
			...
			<div className="relative z-10 flex w-full max-w-2xl flex-col items-center px-6 text-center sm:px-8">
				...
				<div className="mt-10 flex w-full flex-col sm:flex-row gap-3">
					<Button
						variant="glass"
						size="large"
						className="w-full sm:flex-1 font-semibold rounded-2xl shadow-[0_0_30px_rgba(180,120,255,0.35)] hover:shadow-[0_0_40px_rgba(180,120,255,0.55)] border-white/30 bg-white/15 hover:bg-white/22 text-white"
						onClick={() =>
							document
					...
					<Button
						variant="ghost"
						size="large"
						className="w-full sm:flex-1 font-medium rounded-2xl border border-white/15 bg-white/[0.05] text-white/70 hover:text-white hover:bg-white/10 hover:border-white/25 backdrop-blur-sm"
