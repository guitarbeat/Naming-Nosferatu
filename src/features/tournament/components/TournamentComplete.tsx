			...
			<div className="relative z-10 flex w-full max-w-2xl flex-col items-center px-6 text-center sm:px-8">
				...
				<div className="mt-10 flex w-full flex-col gap-3">
					<Button
						...
						className="flex w-full items-center justify-center gap-2.5 rounded-2xl px-6 py-4 text-sm font-semibold shadow-[0_0_30px_rgba(180,120,255,0.35)] backdrop-blur-sm transition-all hover:shadow-[0_0_40px_rgba(180,120,255,0.55)]"
					>
						<Trophy size={15} />
						View Analysis
					</Button>
					...
					<Button
						...
						className="flex w-full items-center justify-center gap-2.5 rounded-2xl border border-white/15 bg-white/[0.05] px-6 py-4 text-sm font-medium text-white/70 backdrop-blur-sm transition-all hover:border-white/25 hover:bg-white/10 hover:text-white"
					>
						<LogOut size={15} />
