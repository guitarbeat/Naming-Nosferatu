...
// Selection badge component — always visible, shows empty state when unselected
const SelectionBadge = ({ isSelected }: { isSelected: boolean }) => (
	<div className="absolute top-2.5 left-2.5 z-20">
		{isSelected ? (
			...
			<div className="size-6 sm:size-7 rounded-full border-2 border-foreground/20 bg-background/60 backdrop-blur-sm" />
		)}
	</div>
);
