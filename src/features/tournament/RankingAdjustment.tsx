...
interface DraggableRankingCardProps {
  item: RankingItem;
  index: number;
}

// * Memoized list item to prevent unnecessary re-renders during drag operations and parent updates
const DraggableRankingCard = React.memo(({ item, index }: DraggableRankingCardProps) => {
  return (
...
DraggableRankingCard.displayName = "DraggableRankingCard";
