...
const mockNames: NameItem[] = [
    { id: "1", name: "Cat 1", description: "Desc 1", isActive: true, isHidden: false, status: "candidate", provenance: null, avgRating: 1500, createdAt: null, pronunciation: undefined, lockedIn: false, has_user_rating: false },
    { id: "2", name: "Cat 2", description: "Desc 2", isActive: true, isHidden: false, status: "candidate", provenance: null, avgRating: 1500, createdAt: null, pronunciation: undefined, lockedIn: false, has_user_rating: false },
];
...
describe("useNameSelection", () => {
    ...
    it("persists to localStorage with debounce", () => {
        ...
        const { result } = renderHook(() => useNameSelection({ names: mockNames, userName: "testuser" }));
