...
const MatchNodeCard = memo(function MatchNodeCard({
	...
	return (
		<motion.div
			...
			className={`group/card relative w-64 sm:w-72 flex flex-col rounded-[2rem] border transition-all duration-300 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07),inset_0_1px_1px_0_rgba(255,255,255,0.2)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.1)] ${
				isLive
					? "border-primary shadow-[0_0_24px_hsl(var(--primary)/0.25),inset_0_1px_1px_0_rgba(255,255,255,0.3)] ring-2 ring-primary/40 bg-card/90 dark:bg-card/80"
					: isCompleted
						? "border-border/60 dark:border-white/10 bg-card/80 dark:bg-[#120f17]/80 hover:border-border/90 hover:bg-card/90"
						: isBye
							? "border-border/30 dark:border-white/5 bg-card/40 dark:bg-[#120f17]/40 opacity-70"
							: "border-border/40 dark:border-white/10 bg-card/60 dark:bg-[#120f17]/60 hover:bg-card/75"
...
function ChampionPodium({ champion, isComplete, onSelectContender }: ChampionPodiumProps) {
	if (!champion && !isComplete) {
		return (
			<div className="w-56 sm:w-64 flex flex-col items-center justify-center p-6 rounded-3xl border border-dashed border-white/20 dark:border-white/10 bg-card/40 dark:bg-black/30 backdrop-blur-xl text-center gap-3 shadow-[0_8px_24px_rgba(0,0,0,0.06),inset_0_1px_1px_rgba(255,255,255,0.15)]">
				<div className="size-14 rounded-2xl border border-white/20 dark:border-white/10 bg-white/30 dark:bg-white/5 flex items-center justify-center text-muted-foreground/60 shadow-inner">
	...
	return (
		<motion.div
			...
			className="group/champion relative w-60 sm:w-72 flex flex-col items-center overflow-hidden rounded-3xl border-2 border-amber-500/60 bg-gradient-to-b from-amber-500/20 via-card/85 to-card/95 p-5 text-center shadow-[0_0_40px_rgba(245,158,11,0.25),inset_0_1px_2px_rgba(255,255,255,0.4)] backdrop-blur-2xl"
		>
	...
	return (
		...
		>
			<motion.div
				...
				className="relative w-full max-w-md overflow-hidden rounded-[2.5rem] border border-white/30 dark:border-white/15 bg-card/85 dark:bg-[#120f17]/85 backdrop-blur-2xl p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.35)]"
			>
				<button
					type="button"
					onClick={onClose}
				...
				<div className="flex flex-col items-center text-center">
					...
					{/* Stats Grid */}
					<div className="mt-6 grid w-full grid-cols-3 gap-3 rounded-[2rem] border border-white/20 dark:border-white/10 bg-white/40 dark:bg-black/30 backdrop-blur-md p-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)]">
...
export function TournamentBracket({
	...
	return (
		<div
			...
			className={`relative flex flex-col w-full rounded-3xl border border-white/20 dark:border-white/10 bg-card/85 dark:bg-[#120f17]/85 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] backdrop-blur-2xl overflow-hidden font-display text-foreground ${
				isModal ? "max-h-[90vh]" : ""
			} ${className}`}
		>
			...
			{/* Top Header & Toolbar */}
			<div className="flex flex-col gap-3 border-b border-border/40 p-4 sm:p-5 bg-card/75 dark:bg-[#120f17]/75 backdrop-blur-xl">
