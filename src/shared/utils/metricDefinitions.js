...
export const METRICS = {
  rating: {
    label: 'Rating',
    shortLabel: 'Rating',
    description: 'Elo-based rating system (similar to chess ratings). Higher is better.',
    fullDescription:
    ...
    helpText: 'A rating of 1700 means this name would be expected to beat ~75% of other names in a 1v1 matchup.',
  },
  ...
  times_selected: {
    ...
    helpText: 'More selections = more data about how this name compares to others.',
  },
  ...
  total_losses: {
    ...
    helpText: 'Losses help balance the rating system—experienced names have both wins and losses.',
  },
  ...
  win_rate: {
    ...
    helpText: 'A 70% win rate is very good. Note: newer names with fewer matchups may have extreme win rates.',
  },
  ...
  popularity_score: {
    ...
    helpText: 'This score combines multiple metrics into one number. Useful for quick comparisons.',
  },
  ...
  unique_selectors: {
    ...
    helpText: 'A name with high selections but few selectors may be a personal favorite of one user.',
  },
  ...
  users_rated: {
    ...
    fullDescription: 'How many unique users participated in matchups involving this name.',
    range: '0–∞',
    examples: [
  ...
  created_at: {
    ...
    fullDescription: 'The date this name entry was created. Newer names may have less history.',
    range: 'Date',
    examples: [
    ...
    helpText: 'Consider the age when interpreting metrics. New names need more time to build a track record.',
  },
...
export const RATING_RANGES = [
  ...
  { min: 1200, max: 1400, label: 'Developing', color: 'var(--color-info, #3b82f6)' },
  { min: 1400, max: 1600, label: 'Solid', color: 'var(--color-warning, #f59e0b)' },
  { min: 1600, max: 1800, label: 'Strong', color: 'var(--color-success, #22c55e)' },
  { min: 1800, max: 2000, label: 'Excellent', color: 'var(--color-gold, #f59e0b)' },
  { min: 2000, max: Infinity, label: 'Elite', color: 'var(--color-purple, #a855f7)' },
];
