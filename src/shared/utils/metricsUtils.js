 ...
 * @param {number} _value - The metric value (unused, kept for API compatibility)
 * @param {number} percentile - The percentile rank (0-100)
 * @returns {string} CSS variable or color name
 */
export function getMetricColor(metricName, _value = 0, percentile = 50) {
 ...
 * @param {string} _metricName - The metric name (unused, kept for API compatibility)
