		...
		variants: {
			variant: {
				primary: [
					...
					"active:translate-y-0 active:shadow-sm active:brightness-95 active:scale-[0.96]",
				].join(" "),
				secondary: [
					...
					"active:translate-y-0 active:shadow-sm active:bg-secondary/70 active:scale-[0.96]",
				].join(" "),
				danger: [
				...
				outline: [
					...
					"active:translate-y-0 active:bg-accent/50 active:scale-[0.96]",
				].join(" "),
				link: [
