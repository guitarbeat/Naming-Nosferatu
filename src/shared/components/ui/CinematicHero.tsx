...
export function CinematicHero({
	...
	useEffect(() => {
		...
		const ctx = gsap.context(() => {
			...
			gsap.set([".card-left-content", ".card-right-content", ".mockup-wrapper", ".card-badge"], {
				autoAlpha: 0,
			});
			...
			>
				...
				>
					...
					<div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-between lg:justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
						...
						<div
							className="mockup-wrapper order-2 lg:order-2 relative w-full h-[300px] lg:h-[500px] flex items-center justify-center z-10"
										...
										<div className="flex-1 flex flex-col gap-3">
											...
											<div className="flex justify-between items-center px-2 mb-3">
												<div className="flex flex-col gap-0.5">
													<span className="text-[9px] text-stardust font-bold uppercase tracking-widest">
														Tournament
													</span>
							...
							<div className="flex flex-col lg:items-end gap-2">
								...
								<div className="flex gap-2 items-center justify-center lg:justify-end">
									<div className="flex -space-x-2">
										<div className="w-5 h-5 rounded-full bg-stardust/30 border border-stardust/50 flex items-center justify-center text-[10px]">
											👤
										</div>
										<div className="w-5 h-5 rounded-full bg-hot-pink/30 border border-hot-pink/50 flex items-center justify-center text-[10px]">
											👤
										</div>
										<div className="w-5 h-5 rounded-full bg-white/10 border border-white/30 flex items-center justify-center text-[10px]">
											+3
										</div>
									</div>
