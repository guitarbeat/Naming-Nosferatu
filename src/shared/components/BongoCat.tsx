/**
 * @module BongoCat
 * @description Animated Bongo Cat loading component - a cat typing on a laptop
 * Inspired by https://codepen.io/carolineartz/pen/VwYwZaP
 * Original Bongo Cat by @StrayRogue and @DitzyFlama
 */
...
export const BongoCat = memo(function BongoCat({
	...
	return (
		<div
			...
			aria-label="Loading"
		>
			<svg className={styles.bongoCat} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 787.3 433.8">
				<defs>
					{/* Eye symbol */}
				...
				<g id="bongo-head">
					...
					<g id="bongo-face">
						{/* Eyes */}
						<use href="#bongo-eye" x="340" y="180" width="40" height="40" className={styles.eye} />
						<use href="#bongo-eye" x="460" y="160" width="40" height="40" className={styles.eye} />
				...
				<g id="bongo-laptop">
					...
					<g className={styles.terminal}>
						<path
							d="M195,300 L330,300"
							stroke="#3de0e8"
							strokeWidth="4"
							strokeLinecap="round"
							className={styles.codeLine1}
						/>
						<path
							d="M195,315 L290,315"
							stroke="#3de0e8"
				...
				<g id="bongo-paw-left">
					...
					{/* Paw down state */}
					<g className={styles.pawLeftDown}>
						<ellipse cx="230" cy="350" rx="35" ry="25" fill="#fff" stroke="#000" strokeWidth="3" />
						<use href="#bongo-paw-pads" x="210" y="335" width="40" height="35" />
					</g>
				</g>

				{/* Right Paw */}
				<g id="bongo-paw-right">
					{/* Paw up state */}
					<g className={styles.pawRightUp}>
					...
					{/* Paw down state */}
					<g className={styles.pawRightDown}>
						<ellipse cx="350" cy="350" rx="35" ry="25" fill="#fff" stroke="#000" strokeWidth="3" />
						<use href="#bongo-paw-pads" x="330" y="335" width="40" height="35" />
					</g>
				</g>
			</svg>
