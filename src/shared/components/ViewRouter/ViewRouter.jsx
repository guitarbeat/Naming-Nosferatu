...
const Tournament = lazy(() =>
  import('@features/tournament/Tournament').catch((err) => ({
    default: () => (
      <Error 
        variant="list" 
        error={{ 
...
const TournamentSetup = lazy(() =>
  import('@features/tournament/TournamentSetup').catch((err) => ({
    default: () => (
      <Error 
        variant="list" 
        error={{ 
...
const Results = lazy(() =>
  import('@features/tournament/Results').catch((err) => ({
    default: () => (
      <Error 
        variant="list" 
        error={{ 
...
const Profile = lazy(() =>
  import('@features/profile/Profile').catch((err) => ({
    default: () => (
      <Error 
        variant="list" 
        error={{ 
